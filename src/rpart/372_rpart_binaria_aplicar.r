...
PARAM$experimento  <- "KA3721"

PARAM$semilla  <- 106391
PARAM$input$dataset       <- "C:/Mineria_de_datos/datasets/dataset_pequeno.csv"
PARAM$input$training      <- c( 202107 )  # los meses en los que vamos a entrenar
PARAM$input$future        <- c( 202109 )  #meses donde se aplica el modelo

PARAM$rpart$cp         <- -0.183765510779028 #cambio por los mejores parametros que arrojo el script de cloud
PARAM$rpart$minsplit   <- 1969.08748241575
PARAM$rpart$minbucket  <- 2.03984804566148
PARAM$rpart$mixdepth   <- 10.00

PARAM$prob_corte       <- 0.0500155306388456
