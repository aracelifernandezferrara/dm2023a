...
#semillas: 106391, 106397, 106411, 106417, 106427
particionar( dataset, division=c(7,3), agrupa="clase_ternaria", seed= 106391 )  #Cambiar por la primer semilla de cada uno !
