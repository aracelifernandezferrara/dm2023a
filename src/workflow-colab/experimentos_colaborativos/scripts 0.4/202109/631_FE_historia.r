...
PARAM  <- list()
PARAM$experimento <- "FE6310_exp4_0.4_9"

PARAM$exp_input  <- "DR6210_exp4_0.4_9"
...
PARAM$RandomForest$semilla  <- 106427    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 489113   # cambiar por la propia semilla
