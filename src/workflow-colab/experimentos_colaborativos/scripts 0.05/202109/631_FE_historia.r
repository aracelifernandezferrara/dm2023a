...
PARAM  <- list()
PARAM$experimento <- "FE6310_exp2_0.05"

PARAM$exp_input  <- "DR6210_exp2_0.05"
...
PARAM$RandomForest$semilla  <- 106391    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 557537   # cambiar por la propia semilla
