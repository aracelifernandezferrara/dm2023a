...
PARAM  <- list()
PARAM$experimento <- "TS6410_exp1_0.01_7"

PARAM$exp_input  <- "FE6310_exp1_0.01_7"

# me salteo los meses duros de pandemia, pero llego hasta 201907 en training
# entreno en 18 meses

PARAM$future <- c( 202107)
PARAM$final_train <- c( 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201910, 201909 )

PARAM$train$training <- c( 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907 )
...
PARAM$train$undersampling  <- 0.01   # 1.0 significa NO undersampling ,  0.1  es quedarse con el 10% de los CONTINUA

PARAM$train$semilla  <- 562019  # cambiar por su propia semilla  !!!
