...
PARAM  <- list()
PARAM$experimento <- "FE6310_exp1_0.01_9"

PARAM$exp_input  <- "DR6210_exp1_0.01_9"
...
PARAM$RandomForest$semilla  <-562019     # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 106417   # cambiar por la propia semilla
