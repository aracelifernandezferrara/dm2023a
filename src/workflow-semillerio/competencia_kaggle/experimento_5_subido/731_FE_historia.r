...
PARAM  <- list()
PARAM$experimento <- "FE7310_exp5"

PARAM$exp_input  <- "DR7210_exp5"
...
PARAM$RandomForest$semilla  <- 489113    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 852197   # cambiar por la propia semilla
