...
PARAM  <- list()
PARAM$experimento <- "FE7310_experimento2"

PARAM$exp_input  <- "DR7210_experimento2"
...
PARAM$RandomForest$semilla  <- 557537    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 562019   # cambiar por la propia semilla
