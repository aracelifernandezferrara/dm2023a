...
PARAM  <- list()
PARAM$experimento  <- "ZZ7950_experimento2"
PARAM$exp_input  <- "HT7510_experimento2"

PARAM$modelos_rank  <- c( 40)  #Que modelos quiero, segun su posicion en el ranking e la Bayesian Optimizacion, ordenado por ganancia descendente,
