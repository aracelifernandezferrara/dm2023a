...
PARAM  <- list()
PARAM$experimento <- "FE7310_experimento4"

PARAM$exp_input  <- "DR7210_experimento4"
...
PARAM$RandomForest$semilla  <- 106417    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 309007   # cambiar por la propia semilla
