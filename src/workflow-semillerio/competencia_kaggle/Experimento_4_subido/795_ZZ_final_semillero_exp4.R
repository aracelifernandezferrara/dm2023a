...
PARAM  <- list()
PARAM$experimento  <- "ZZ7950_experimento4"
PARAM$exp_input  <- "HT7510_experimento4"

PARAM$modelos_rank  <- c( 1,50 )  #Que modelos quiero, segun su posicion en el ranking e la Bayesian Optimizacion, ordenado por ganancia descendente
PARAM$semillerio  <- 50   # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad
PARAM$semilla_primos  <- 106417  # se utiliza para generar el vector de  PARAM$semillerio  semillas
