...
PARAM  <- list()
PARAM$experimento  <- "ZZ7950_experimento3"
PARAM$exp_input  <- "HT7510_experimento3"

PARAM$modelos_rank  <- c( 50 )  #Que modelos quiero, segun su posicion en el ranking e la Bayesian Optimizacion, ordenado por ganancia descendente,
