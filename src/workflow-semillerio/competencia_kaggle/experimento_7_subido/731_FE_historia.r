...
PARAM  <- list()
PARAM$experimento <- "FE7310_exp6"

PARAM$exp_input  <- "DR7210_exp6"
...
PARAM$RandomForest$semilla  <- 189523    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 189643   # cambiar por la propia semilla
