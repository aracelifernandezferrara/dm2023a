...
PARAM  <- list()
PARAM$experimento  <- "ZZ7950_exp7"
PARAM$exp_input  <- "HT7510_exp6"

PARAM$modelos_rank  <- c( 10,50 )  #Que modelos quiero, segun su posicion en el ranking e la Bayesian Optimizacion, ordenado por ganancia descendente
PARAM$semillerio  <- 100   # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad
PARAM$semilla_primos  <- 309007  # se utiliza para generar el vector de  PARAM$semillerio  semillas
